...
{
    private string connectionString = "Server=Elias_Cano\\SQLEXPRESS;Database=ProveeDesk;Trusted_Connection=True;Encrypt=True;TrustServerCertificate=True;"; // Ajusta tu cadena de conexión
